...
function About() {
  return (
    <div className="about-container">
      ...
      <h2 h2 className="family-info">John, your Certified Plungeologist here, hoping my services were ALL You Needed.. any questions or comments please contact me below!</h2>
